...
Thanks for your interest in contributing to `handshake` — Pilot Protocol handshake plugin — node-to-node trust negotiation, accept/deny flow, trust persistence (port 444).

## Quick start

```bash
git clone https://github.com/pilot-protocol/handshake.git
cd handshake
go test -race ./...
```
